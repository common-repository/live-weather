...
<div class="body_themes_th" style="background-color: <?php echo $background_color; ?>;color: <?php echo $text_color; ?>">

	<div class="wether_themes_2_th">
		...
		<div class="wether_themes_2_data_th">
